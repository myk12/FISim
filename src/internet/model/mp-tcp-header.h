...
//Setters
  /**
   * \param port The source port for this MPTcpHeader
   */
  void
  SetSourcePort(uint16_t port);
  /**
   * \param port the destination port for this MPTcpHeader
   */
  void
  SetDestinationPort(uint16_t port);
  /**
   * \param sequenceNumber the sequence number for this MPTcpHeader
   */
  void
  SetSequenceNumber(SequenceNumber32 sequenceNumber);
  /**
   * \param ackNumber the ACK number for this MPTcpHeader
   */
  void
  SetAckNumber(SequenceNumber32 ackNumber);
  /**
   * \param length the length of this MPTcpHeader
   */
  void
  SetLength(uint8_t length);
  /**
   * \param flags the flags for this MPTcpHeader
   */
  void
  SetFlags(uint8_t flags);
  /**
   * \param windowSize the window size for this MPTcpHeader
   */
  void
  SetWindowSize(uint16_t windowSize);
  /**
   * \param urgentPointer the urgent pointer for this MPTcpHeader
   */
  void
...
//Getters
  /**
   * \return The source port for this MPTcpHeader
   */
  uint16_t
  GetSourcePort() const;
  /**
   * \return the destination port for this MPTcpHeader
   */
  uint16_t
  GetDestinationPort() const;
  /**
   * \return the sequence number for this MPTcpHeader
   */
  SequenceNumber32
  GetSequenceNumber() const;
  /**
   * \return the ACK number for this MPTcpHeader
   */
  SequenceNumber32
  GetAckNumber() const;
  /**
   * \return the length of this MPTcpHeader
   */
  uint8_t
  GetLength() const;
  /**
   * \return the flags for this MPTcpHeader
   */
  uint8_t
  GetFlags() const;
  /**
   * \return the window size for this MPTcpHeader
   */
  uint16_t
  GetWindowSize() const;
  /**
   * \return the urgent pointer for this MPTcpHeader
   */
  uint16_t
