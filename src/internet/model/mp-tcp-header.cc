...
void
MPTcpHeader::EnableChecksums(void)
{
  m_calcChecksum = true;
}

void
MPTcpHeader::SetSourcePort(uint16_t port)
{
  m_sourcePort = port;
}
void
MPTcpHeader::SetDestinationPort(uint16_t port)
{
  m_destinationPort = port;
}
void
MPTcpHeader::SetSequenceNumber(SequenceNumber32 sequenceNumber)
{
  m_sequenceNumber = sequenceNumber;
}
void
MPTcpHeader::SetAckNumber(SequenceNumber32 ackNumber)
{
  m_ackNumber = ackNumber;
}
void
MPTcpHeader::SetLength(uint8_t length)
{
  m_length = length;
}
void
MPTcpHeader::SetFlags(uint8_t flags)
{
  m_flags = flags;
}
void
MPTcpHeader::SetWindowSize(uint16_t windowSize)
{
  m_windowSize = windowSize;
}
void
MPTcpHeader::SetUrgentPointer(uint16_t urgentPointer)
{
  m_urgentPointer = urgentPointer;
}

uint16_t
MPTcpHeader::GetSourcePort() const
{
  return m_sourcePort;
}
uint16_t
MPTcpHeader::GetDestinationPort() const
{
  return m_destinationPort;
}
SequenceNumber32
MPTcpHeader::GetSequenceNumber() const
{
  return m_sequenceNumber;
}
SequenceNumber32
MPTcpHeader::GetAckNumber() const
{
  return m_ackNumber;
}
uint8_t
MPTcpHeader::GetLength() const
{
  return m_length;
}
uint8_t
MPTcpHeader::GetFlags() const
{
  return m_flags;
}
uint16_t
MPTcpHeader::GetWindowSize() const
{
  return m_windowSize;
}
uint16_t
MPTcpHeader::GetUrgentPointer() const
{
  return m_urgentPointer;
}

void
MPTcpHeader::InitializeChecksum(Ipv4Address source, Ipv4Address destination, uint8_t protocol)
{
  m_source = source;
...
void
MPTcpHeader::InitializeChecksum(Ipv6Address source, Ipv6Address destination, uint8_t protocol)
{
  m_source = source;
  m_destination = destination;
  m_protocol = protocol;
...
void
MPTcpHeader::InitializeChecksum(Address source, Address destination, uint8_t protocol)
{
  m_source = source;
  m_destination = destination;
  m_protocol = protocol;
...
uint16_t
MPTcpHeader::CalculateHeaderChecksum(uint16_t size) const
{
...
bool
MPTcpHeader::IsChecksumOk(void) const
{
...
{
  static TypeId tid = TypeId("ns3::MPTcpHeader").SetParent<Header>().AddConstructor<MPTcpHeader>();
  return tid;
}
...
/*
 void
 MPTcpHeader::Print(std::ostream &os) const
 {
...
uint32_t
MPTcpHeader::GetSerializedSize(void) const
{
  return 4 * m_length;
}
void
...
/*
 void
 MPTcpHeader::Serialize(Buffer::Iterator start) const
 {
...
/*
 uint32_t
 MPTcpHeader::Deserialize(Buffer::Iterator start)
 {
 Buffer::Iterator i = start;
